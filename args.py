...
group.add_argument(
    ...
    type=str,
    default='mnist32',
    choices=['celeba32', 'mnist32', 'cifar10', 'chair600', 'msds1', 'msds2', 'mnist'],
    help='dataset name',
)
group.add_argument(
    '--data_path',
...
group.add_argument(
    ...
    type=int,
    default=2,
    help='expected length of sequence. length = 4^(seq_length-1)',
)
...
group.add_argument(
    ...
    type=str,
    default='gamma',
    choices=['gaussian', 'laplace','poisson','gamma'],
...
group.add_argument(
    ...
    type=int,
    default=20,
    help='how many episodes to collect per training run',
)
...
def get_net_name():
    ...
    net_name += 'nl{nlayers}_nr{nresblocks}_nm{nmlp}_nh{nhidden}_a{concentration}_b{rate}'
